...
data_tmx = open(tkFileDialog.askopenfilename(title='Open a TMX file.'), "rb").read()
data_spr = open(tkFileDialog.askopenfilename(title='Open a SPR file.'), "rb").read()
